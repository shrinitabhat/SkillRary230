...
/**
 * This class contains all the elements and respective business libraries of skillrarydemp app page
 * @author Admin
 *
 */
public class SkillraryDempAppPage {
	...
	//Initialization
	public SkillraryDempAppPage(WebDriver driver) {
